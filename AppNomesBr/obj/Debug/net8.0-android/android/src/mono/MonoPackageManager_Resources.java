...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AppNomesBr.dll" comes first in this list. */
		"AppNomesBr.dll",
		"GoogleGson.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"AppNomesBr.Domain.dll",
		"AppNomesBr.Infrastructure.dll",
		"AppNomesBr.Infrastructure.IoC.dll",
		"AppNomesBr.Service.dll",
